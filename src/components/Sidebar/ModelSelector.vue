...
<template>
  <div>
    <span class="nav-link" style="padding: 0.2vw"><i class="bi bi-cpu"></i>Model</span>
    <fieldset class="btn-group" role="group" style="padding: 0.2vw; width: 100%">
      ...
      <input
        ...
        data-bs-target="#modalSettingsModel"
      />
    ...
    <div
      id="modalSettingsModel"
      class="modal fade"
      tabindex="-1"
      aria-labelledby="modalSettingsModelLabel"
      aria-hidden="true"
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>
                ...
                Therefore, the images must be transferred to the webservice for processing. The open
                format allows it to create individual webservices by everyone and can be easily
                swapped.
              </p>
              ...
              <p>
                ...
                This call is used to detect a single face on a provided image file inside a POST
                request.
                <br /><code>/annotations</code><br />
                This call is used to sync the annotations inside a POST request when the user
                triggers the download.
              </p>
              <hr />
              <h6>URL</h6>
              <p>
                Insert the webservice URL in the text field below and submit with hitting the Save
                button.
              </p>
